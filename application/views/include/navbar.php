	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url(); ?>">
				<img alt="<?php echo config_item('web_title'); ?>" src="<?php echo config_item('img'); ?>muliabaja.png">
			</a>
		</div>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li <?php if($controller == 'menu') { echo "class='active'"; } ?>><a href="<?php echo site_url('menu'); ?>"><i class='fa fa-home -o fa-fw'></i> Menu</a></li>
				<?php } ?>
				...
				<?php if($level == 'admin' OR $level == 'keuangan' OR $level == 'kasir') { ?>
				<li class="dropdown <?php if($controller == 'retur') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-refresh fa-fw'></i> Retur <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<?php if($level !== 'keuangan'){ ?>
						<li><a href="<?php echo site_url('retur/retur_pembelian'); ?>">Retur Pembelian</a></li>
						<?php } ?>
						<li><a href="<?php echo site_url('retur/retur_penjualan'); ?>">Retur Penjualan</a></li>
					</ul>
				</li>
				<?php } ?>
