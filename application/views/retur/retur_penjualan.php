...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5><i class='fa fa-random fa-fw'></i> Retur <i class='fa fa-angle-right fa-fw'></i> Retur Penjualan</h5>
			<hr />
...
{
	$tambahan .= nbs(2)."<a href='".site_url('barang/tambah')."' class='btn btn-default' id='TambahBarang'><i class='fa fa-plus fa-fw'></i> Tambah Retur Pembelian</a>";
